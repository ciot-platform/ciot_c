...
typedef enum ciot_iface_type {
    ...
    CIOT_IFACE_TYPE_WIFI_MULTI = 28 /* Multi-WiFi orchestrator interface type. */
} ciot_iface_type_t;
...
#define _CIOT_IFACE_TYPE_MAX CIOT_IFACE_TYPE_WIFI_MULTI
#define _CIOT_IFACE_TYPE_ARRAYSIZE ((ciot_iface_type_t)(CIOT_IFACE_TYPE_WIFI_MULTI+1))
...
#define CIOT_IFACE_TYPE_IFACE_TYPE_WIFI_MULTI CIOT_IFACE_TYPE_WIFI_MULTI
