...
typedef enum ciot_gpio_state {
    ...
    CIOT_GPIO_STATE_BLINKING_REVERSE = 6, /* Gpio is alternating its state in reverse phase */
    CIOT_GPIO_STATE_BLINKING_SLOW = 7 /* Gpio is alternating its state at half speed */
} ciot_gpio_state_t;
...
#define _CIOT_GPIO_STATE_MAX CIOT_GPIO_STATE_BLINKING_SLOW
#define _CIOT_GPIO_STATE_ARRAYSIZE ((ciot_gpio_state_t)(CIOT_GPIO_STATE_BLINKING_SLOW+1))
...
#define CIOT_GPIO_STATE_GPIO_STATE_BLINKING_REVERSE CIOT_GPIO_STATE_BLINKING_REVERSE
#define CIOT_GPIO_STATE_GPIO_STATE_BLINKING_SLOW CIOT_GPIO_STATE_BLINKING_SLOW
